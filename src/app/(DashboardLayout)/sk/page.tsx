      ...
      <>
        ...
        >
          <Breadcrumbs aria-label="breadcrumb">
            ...
            <Typography color="textPrimary">SK</Typography>
          </Breadcrumbs>
          <Button
            variant="contained"
            color="primary"
        ...
        <Grid container spacing={2} mt={2}>
          ...
          <Grid item xs={12} sm={6} md={4} lg={3}>
            <FormControl fullWidth>
              <InputLabel>SK Level</InputLabel>
              <Select
                value={semarLevel || ""}
                onChange={(e) => setSemarLevel(e.target.value)}
                label="Semar Level"
              >
                <MenuItem value="">
                  <em>Semua</em>
                ...
                {semarLevels.map((level) => (
                  <MenuItem key={level.semarLevelID} value={level.semarLevelID}>
                    {level.deskripsi}
                  </MenuItem>
                ))}
              </Select>
        ...
        <Box mt={4}>
          <ActivityTable
            ...
            totalCount={totalCountSK}
            fetchData={fetchDataSK}
            dataLimit={totalCountSK} // Set dataLimit to 10
          />
        </Box>
      </>
    </BaseCard>
